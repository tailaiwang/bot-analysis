        ...
        <div className='post'>
          ...
          <div className='col-md-10 mx-auto lead'>
            ...
            <p className='content-paragraph'>
              ...
              With recent events like the degradation of the Twitter platform and increased post-IPO scrutiny on Reddit, the bot problem seems to be under a spotlight. Being Twitter/Reddit users ourselves,
              our team was keenly aware of this bot problem and had many anecdotes of spam, scams, and toxicity. We started our research project in early February with the goal of better understanding the whole bot problem,
              and what kind of impact bots have not just on Twitter & Reddit, but also on other popular platforms like Facebook and Instagram. In particular, we set out to try and answer the following questions:
            </p>
            ...
            <p className='content-paragraph'>
              ...
              and for what reasons are they being created.  Next, the state of the industry section covers what current industry players like Facebook are doing to mitigate this problem and
              how they’re measuring the problem themselves. Finally, in addition to our secondary research, our team wanted to perform
              some of our own research using Reddit’s platform to see how effective existing tools are at detecting bots and
              how their performance differs. This primary research will be covered in the analysis section.
